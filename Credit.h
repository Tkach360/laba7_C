...
public:
	...
	// перегрузка оператора присваивани€ объекту производного класса объекта базового класса
	...
	static double getRegularContribution(int years, double body, double percent) {
		...
		contrib += 0.01; // дл€ ликвидации ошибки св€занной с машинным представлением числел
